...
FILTER="seg_sim_score_0.6_sim_score_0.8" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/seg_sim_score_sim_score/seg_sim_score_0.6_sim_score_0.8" # <-- can be changed (threshold filter)
EPOCH_STEPS=103058 # <-- change depending on dataset
