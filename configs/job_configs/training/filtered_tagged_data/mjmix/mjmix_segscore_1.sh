...
FILTER="mjmix_segscore_1" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/mjmix_segscore_1" # <-- can be changed (threshold filter)
EPOCH_STEPS=102693 # <-- change depending on dataset
