...
EPOCHS=5
NUM_WORKERS=8 # <-- might need to tune
...
JOB_TYPE="debug"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/text_heurs_seg_edit_dist_edit_dist/text_heurs_seg_edit_dist_0.7_edit_dist_0.5/50K" # <-- can be changed (threshold filter)
