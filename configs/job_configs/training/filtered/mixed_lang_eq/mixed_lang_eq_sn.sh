...
FILTER="mixed_lang_eq" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/mixed_lang_eq" # <-- can be changed (threshold filter)
EPOCH_STEPS=103071 # <-- change depending on dataset
