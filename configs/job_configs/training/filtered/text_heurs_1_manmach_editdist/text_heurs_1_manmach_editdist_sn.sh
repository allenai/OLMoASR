...
FILTER="text_heurs_1_manmach_0.9_editdist_0.28_feb_25" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
LEARNING_RATE=2.5e-3 # <-- might need to tune
LR="25e4" # <-- might need to tune
AUDIO_HOURS=440
BATCH_SIZE=64
GPU_COUNT=8
REPLICAS=1
...
JOB_TYPE="tuning"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/text_heurs_1_manmach_0.9_editdist_0.28_feb_25" # <-- can be changed (threshold filter)
EPOCH_STEPS=101965 # <-- change depending on dataset
