...
FILTER="text_heurs_1_manmach_0.9_editdist_0.28_lang_align_en" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_data/text_heurs_1_manmach_0.9_editdist_0.28_lang_align_en_mar_25" # <-- can be changed (threshold filter)
EPOCH_STEPS=102998 # <-- change depending on dataset
