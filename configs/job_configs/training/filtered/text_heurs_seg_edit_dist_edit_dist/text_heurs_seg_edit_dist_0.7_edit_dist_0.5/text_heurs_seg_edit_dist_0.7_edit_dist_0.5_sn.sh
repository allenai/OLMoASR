...
JOB_TYPE="owsm_ow"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/text_heurs_seg_edit_dist_edit_dist/text_heurs_seg_edit_dist_0.7_edit_dist_0.5/452K" # <-- can be changed (threshold filter)
EPOCH_STEPS=106125 # <-- change depending on dataset
TRAIN_STEPS=106125 # <-- change depending on effective batch size
