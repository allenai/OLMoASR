...
FILTER="seg_edit_dist_0.6_edit_dist_0.4" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/seg_edit_dist_edit_dist/seg_edit_dist_0.6_edit_dist_0.4" # <-- can be changed (threshold filter)
EPOCH_STEPS=103038 # <-- change depending on dataset
