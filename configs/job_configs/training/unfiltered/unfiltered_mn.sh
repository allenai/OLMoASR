...
EXP_NAME="${MODEL_SIZE}_${LR}_${AUDIO_HOURS}K_bs${BATCH_SIZE}_ebs${EFFECTIVE_BATCH_SIZE}_${NUM_WORKERS}workers_${EPOCHS}pass"
...
JOB_TYPE="unfiltered"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/unfiltered_apr25" # <-- can be changed (threshold filter)
