...
JOB_TYPE="tuning"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/text_heurs_seg_edit_dist_edit_dist/text_heurs_seg_edit_dist_0.7_edit_dist_0.5/220K" # <-- can be changed (threshold filter)
