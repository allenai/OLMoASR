...
FILTER="seg_sim_score_0.7_edit_dist_0.5" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/seg_sim_score_edit_dist/seg_sim_score_0.7_edit_dist_0.5" # <-- can be changed (threshold filter)
EPOCH_STEPS=103044 # <-- change depending on dataset
