...
FILTER="seg_sim_score_0.9_sim_score_0.9" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/seg_sim_score_sim_score/seg_sim_score_0.9_sim_score_0.9" # <-- can be changed (threshold filter)
EPOCH_STEPS=102972 # <-- change depending on dataset
