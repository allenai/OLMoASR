...
FILTER="mjmix_segscore_2" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/mjmix_segscore_2" # <-- can be changed (threshold filter)
EPOCH_STEPS=102647 # <-- change depending on dataset
