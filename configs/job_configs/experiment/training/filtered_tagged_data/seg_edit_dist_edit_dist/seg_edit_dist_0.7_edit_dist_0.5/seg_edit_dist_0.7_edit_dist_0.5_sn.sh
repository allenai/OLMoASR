...
FILTER="seg_edit_dist_0.7_edit_dist_0.5" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="debug"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_tagged/seg_edit_dist_edit_dist/seg_edit_dist_0.7_edit_dist_0.5" # <-- can be changed (threshold filter)
EPOCH_STEPS=103042 # <-- change depending on dataset
