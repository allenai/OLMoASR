...
FILTER="text_heurs_1_manmach_emb_le_0.978859_ge_0.89765" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_data/text_heurs_1_manmach_emb_le_0.978859_ge_0.897653_feb_25" # <-- can be changed (threshold filter)
EPOCH_STEPS=102364 # <-- change depending on dataset
