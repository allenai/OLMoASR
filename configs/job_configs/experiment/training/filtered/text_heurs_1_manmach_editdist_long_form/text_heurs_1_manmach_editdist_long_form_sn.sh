...
FILTER="debug_longform_6" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="debug"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/filtered_from_data/text_heurs_1_manmach_0.9_editdist_0.28_feb_25_long_form" # <-- can be changed (threshold filter)
EPOCH_STEPS=92486 # <-- change depending on dataset
