...
FILTER="text_heurs_1_text_heurs_2b" # <-- can be changed (threshold filter)
MODEL_SIZE="tiny"
...
JOB_TYPE="filtering"
SAMPLES_DICTS_DIR="/weka/huongn/training_data/filtered/text_heurs_1_text_heurs_2b_feb_25" # <-- can be changed (threshold filter)
EPOCH_STEPS=102413 # <-- change depending on dataset
