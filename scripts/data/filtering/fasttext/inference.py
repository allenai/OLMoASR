...
class OWTedliumQualityClassifier(BaseFastTextTagger):
    ...
    def modify_text(self, text):
        ...
        primary_pattern = f"{pattern_brackets}|{pattern_parentheses}|{pattern_colon}|{specific_strings}"
    ...
    def predict_slice(self, text_slice: TextSlice) -> Iterable[Prediction]:
        ...
        label = (
            pred_label.replace("__label__", "")
            .replace("positive", "score")
            .replace("negative", "score")
        )
...
@add_tagger("ow-librispeech-clean-quality")
class OWLibrispeechCleanQualityClassifier(BaseFastTextTagger):
    MODEL_PATH = "/mnt/raid0/librispeech_clean.bin"
    MAX_CHAR_LEN = 399
...
@add_tagger("ow-librispeech-other-quality")
class OWLibrispeechOtherQualityClassifier(BaseFastTextTagger):
    MODEL_PATH = "/mnt/raid0/librispeech_other.bin"
    MAX_CHAR_LEN = 454
