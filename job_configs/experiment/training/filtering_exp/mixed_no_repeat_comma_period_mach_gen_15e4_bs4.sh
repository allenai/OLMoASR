gantry run \
  --name "mixed_no_repeat_comma_period_mach_gen_large_15e4_440K_bs4_ebs256_5pass_120424" \
  ...
  -- /bin/bash -c "torchrun --nnodes 1 --nproc_per_node 8 scripts/training/train_fsdp.py \
      --model_variant=large \
      --exp_name=mixed_no_repeat_comma_period_mach_gen_large_15e4_440K_bs4_ebs256_5pass_120424 \
      --job_type=filtering \
