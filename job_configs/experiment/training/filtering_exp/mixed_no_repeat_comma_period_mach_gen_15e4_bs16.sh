...
JOB_TYPE="debug"
SAMPLES_DICTS_DIR="/weka/huongn/samples_dicts/filtered/mixed_no_repeat_min_comma_period_full_1_2"
TRAIN_STEPS=1048576
EPOCH_STEPS=206699
EVAL_BATCH_SIZE=16
NUM_WORKERS=8
...
gantry run \
  ...
  --env NCCL_DEBUG=INFO \
  -- /bin/bash -c "torchrun --nnodes 1 --nproc_per_node ${GPU_COUNT} scripts/training/train_fsdp.py \
