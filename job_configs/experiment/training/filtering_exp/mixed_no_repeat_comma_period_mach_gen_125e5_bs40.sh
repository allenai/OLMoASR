gantry run \
  --name "mixed_no_repeat_comma_period_mach_gen_tiny_125e5_440K_bs40_ebs320_5pass_113024" \
  ...
  -- /bin/bash -c "torchrun --nnodes 1 --nproc_per_node 8 scripts/training/train.py \
      --model_variant=tiny \
      --exp_name=mixed_no_repeat_comma_period_mach_gen_tiny_125e5_440K_bs40_ebs320_5pass_113024 \
      --job_type=filtering \
