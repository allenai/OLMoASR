gantry run \
  --name "mixed_no_repeat_comma_period_mach_gen_175e5_440K_bs44_ebs352_1pass_112124" \
  ...
  -- /bin/bash -c "torchrun --nnodes 1 --nproc_per_node 8 scripts/training/train.py \
      --model_variant=tiny \
      --exp_name=mixed_no_repeat_comma_period_mach_gen_175e5_440K_bs44_ebs352_1pass_112124 \
      --job_type=filtering \
