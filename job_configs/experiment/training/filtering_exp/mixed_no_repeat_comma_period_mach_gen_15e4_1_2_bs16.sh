gantry run \
  --name "mixed_no_repeat_comma_period_mach_gen_15e4_230K_bs16_ebs256_111324" \
  ...
  -- /bin/bash -c "torchrun --nnodes 1 --nproc_per_node 8 scripts/training/train.py \
      --model_variant=tiny \
      --exp_name=mixed_no_repeat_comma_period_mach_gen_15e4_230K_bs16_ebs256_111324 \
      --job_type=filtering \
      --samples_dicts_dir=/weka/huongn/ow_filtering/mixed_no_repeat_min_comma_peri0412od \
      --train_steps=89221 \
      --epoch_steps=89221 \
      --ckpt_file_name=None \
